package practice.doc_archive;

import practice.doc_archive.dao.ArchiveImpl1;
import practice.doc_archive.model.Document1;
import practice.doc_archive.model.Menu;
...
public class ArchiveAppl {
    public static void main(String[] args) {
        ...
        ArchiveImpl1 archive = new ArchiveImpl1(100);
        ...
        while (true) {
            ...
            switch (choice) {
                case 1: {
                    ...
                    Document1 document = new Document1(folderId, documentId, title, url, currTime);
